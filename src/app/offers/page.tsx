...
export default function OffersPage() {
  ...
  const handleCreateReminder = (offerId: string, offerTitle: string, patientName: string) => {
    router.push(`/reminders/new?offerId=${offerId}&offerTitle=${encodeURIComponent(offerTitle)}&patientName=${encodeURIComponent(patientName)}`);
  };
