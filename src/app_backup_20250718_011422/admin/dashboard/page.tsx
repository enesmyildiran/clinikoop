          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-yellow-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-gray-700">Session Bilgileri</span>
              </div>
              <div className="space-y-1 text-sm">
                <p><span className="font-medium">Session:</span> {session ? 'Aktif' : 'Pasif'}</p>
                <p><span className="font-medium">NextAuth:</span> {session?.user ? 'Çalışıyor' : 'Çalışmıyor'}</p>
