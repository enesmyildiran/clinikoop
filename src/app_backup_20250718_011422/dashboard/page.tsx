        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <Link href="/reminders" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                Tümünü Gör →
              </Link>
            </div>
          </div>
              ...
              <div key={reminder.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Link href={`/reminders/${reminder.id}`} className="p-2 text-gray-400 hover:text-blue-600 transition-colors">
                      <FaEye />
                    </Link>
                    <Link href={`/reminders/${reminder.id}/edit`} className="p-2 text-gray-400 hover:text-green-600 transition-colors">
                      <FaEdit />
                    </Link>
                  </div>
                </div>
            ...
            {patients.map(patient => (
              <div key={patient.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Link href={`/patients/${patient.id}`} className="p-2 text-gray-400 hover:text-blue-600 transition-colors">
                      <FaEye />
                    </Link>
                    <Link href={`/patients/${patient.id}/edit`} className="p-2 text-gray-400 hover:text-green-600 transition-colors">
                      <FaEdit />
                    </Link>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <Link href="/offers" className="text-purple-600 hover:text-purple-700 text-sm font-medium">
                Tümünü Gör →
              </Link>
            </div>
          </div>
              ...
              <div key={offer.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <Link href={`/offers/${offer.id}`} className="p-2 text-gray-400 hover:text-blue-600 transition-colors">
                        <FaEye />
                      </Link>
                      <Link href={`/offers/${offer.id}/edit`} className="p-2 text-gray-400 hover:text-green-600 transition-colors">
                        <FaEdit />
                      </Link>
                    </div>
                  </div>
            ...
            {offers.length > 5 && (
              <div className="p-4 text-center text-gray-500 border-t border-gray-100">
                <p className="text-sm">
                  ...
                  <Link href="/offers" className="text-purple-600 hover:text-purple-700 ml-1 font-medium">
                    Tümünü görüntüle →
                  </Link>
                </p>
              </div>
