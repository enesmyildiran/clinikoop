...
INSERT INTO "new_support_tickets" ("assignedToId", "authorId", "categoryId", "clinicId", "createdAt", "createdById", "description", "id", "priorityId", "statusId", "title", "updatedAt") SELECT "assignedToId", "authorId", "categoryId", "clinicId", "createdAt", "createdById", "description", "id", "priorityId", "statusId", "title", "updatedAt" FROM "support_tickets";
