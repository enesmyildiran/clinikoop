-- AlterTable
ALTER TABLE "patients" ADD COLUMN "facebook" TEXT;
ALTER TABLE "patients" ADD COLUMN "instagram" TEXT;
...
INSERT INTO "new_reminders" ("createdAt", "description", "dueDate", "id", "isCompleted", "isPrivate", "offerId", "priority", "title", "updatedAt", "userId") SELECT "createdAt", "description", "dueDate", "id", "isCompleted", "isPrivate", "offerId", "priority", "title", "updatedAt", "userId" FROM "reminders";
