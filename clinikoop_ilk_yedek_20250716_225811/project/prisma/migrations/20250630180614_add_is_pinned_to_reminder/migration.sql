...
INSERT INTO "new_reminders" ("createdAt", "description", "dueDate", "id", "isPrivate", "offerId", "patientId", "priority", "reason", "status", "title", "updatedAt", "userId") SELECT "createdAt", "description", "dueDate", "id", "isPrivate", "offerId", "patientId", "priority", "reason", "status", "title", "updatedAt", "userId" FROM "reminders";
